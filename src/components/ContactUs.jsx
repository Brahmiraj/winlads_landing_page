...
export default function ContactUs() {
  return (
    <div className="flex justify-center items-center max-w-[2400px] mx-auto max-2xl:flex-col max-2xl:gap-5">
      <div className="text-end poppins 2xl:flex-1 flex flex-col gap-20 justify-center items-end max-2xl:items-center max-2xl:text-center max-2xl:gap-10">
        ...
        <button className="bg-blue-500 text-white p-4 rounded-lg 4xl:text-4xl">Contact Us</button>
      </div>
      <div className="2xl:flex-1 max-sm:scale-125"><ContactUsCard/></div>
    </div>
  );
}
