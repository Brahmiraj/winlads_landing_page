...
export default function Subscription() {
  return (
    <div className="grid grid-cols-5 max-sm:grid-cols-1 max-2xl:grid-cols-3 max-sm:py-0 py-40 justify-between items-center max-w-[2400px] mx-auto px-20 max-2xl:px-10 max-sm:px-5 gap-5">
